...
import { CheckCircle, Download, X } from '@phosphor-icons/react';
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`flex w-full items-center justify-center gap-2 py-2.5 rounded-xl bg-background border border-border text-sm font-bold text-foreground hover:bg-secondary ${pressable}`}
      >
