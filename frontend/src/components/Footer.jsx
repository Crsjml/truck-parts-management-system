...
export default function Footer({ className = "", variant = "default" }) {
  ...
  return (
    <div className={`relative ${className}`}>
      <footer 
        className={`w-full border-t ${borderClass} flex flex-col md:flex-row justify-between items-center gap-4 text-xs ${textClass} shrink-0 font-semibold transition-colors overflow-hidden mt-4 pb-12 pt-4`}
      >
